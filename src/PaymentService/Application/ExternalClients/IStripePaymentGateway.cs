...
{
    Task<StripeChargeResult> ChargeAsync(string paymentMethodId, Money amount, Guid idempotencyKey, OrderId orderId, CustomerId customerId, CancellationToken cancellationToken = default);
